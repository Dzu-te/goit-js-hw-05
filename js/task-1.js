...
// Функція має повернути результат перевірки, чи помістяться всі
// товари в контейнер.Тобто порахувати загальну кількість товарів в
// об’єкті products і повернути true, якщо вона менше або
// дорівнює containerSize, і false, якщо ні.
